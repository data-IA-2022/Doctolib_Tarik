...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AdminCompteAssociation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('admin_compte', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application.admincompte')),
        ...
        migrations.AddField(
            model_name='admincompte',
            name='users',
            field=models.ManyToManyField(limit_choices_to={'role__in': ['medecin', 'patient']}, related_name='admins', through='application.AdminCompteAssociation', to=settings.AUTH_USER_MODEL),
        ),
    ]
