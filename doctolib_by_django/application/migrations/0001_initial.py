    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ManyToManyField(limit_choices_to={'role': 'patient'}, related_name='patients_medecin', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duree_total_palpitations_min', models.IntegerField(blank=True, null=True)),
                ('heure_debut_douleurs_thoraciques', models.TimeField(blank=True, null=True)),
                ('duree_total_douleurs_thoraciques_min', models.IntegerField(blank=True, null=True)),
                ('heure_debut_malaises', models.TimeField(blank=True, null=True)),
                ('duree_total_malaises_min', models.IntegerField(blank=True, null=True)),
